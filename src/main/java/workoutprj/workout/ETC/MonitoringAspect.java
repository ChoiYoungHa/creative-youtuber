...
public class MonitoringAspect {
    ...
    @Pointcut("execution(* workoutprj.workout.Controller..*(..))")
    ...
    // 네트워크 요청 처리 전 로그 기록
    @Before("networkRequestMethods() || databaseTransactionMethod()")
    ...
    // 요청 처리 후 성공적 완료 로그
    @AfterReturning(pointcut = "networkRequestMethods() || databaseTransactionMethod()", returning = "result")
    ...
    // 예외 발생 시 로그 기록
    @AfterThrowing(pointcut = "networkRequestMethods() || databaseTransactionMethod()", throwing = "ex")
